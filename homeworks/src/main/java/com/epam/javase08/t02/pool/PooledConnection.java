...
class PooledConnection implements Connection {
    ...
    private final ConnectionPool parentPool;

    PooledConnection(Connection srcConnection, ConnectionPool parentPool){
        internalConnection=srcConnection;
        this.parentPool=parentPool;
    }

    public void reallyCloseInternalConnection() throws SQLException {
        internalConnection.close();
    }

    @Override
    public void close() throws SQLException {
        parentPool.freeConnection(this);
    }
